...
return [
     ...
     *
     * Written as a string rather than `TemporaryUpload::class` because Media
     * Library Pro is not installed here, so the class does not exist for static
     * analysis to resolve. The value is identical at runtime.
     */
